...
const CursorInner = ({
  ...
  return (
    <motion.div
      className="pointer-events-none fixed top-0 left-0 z-22092002 h-16 w-16 rounded-full bg-white mix-blend-difference backdrop-blur-[1px] will-change-transform"
      style={{
        x: cursorX,
        y: cursorY,
      }}
